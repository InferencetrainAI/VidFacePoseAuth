...
class FaceRec:
    ...
    def model(self, max_itter=3):       
        ...
        if sum(booleans) > 0:
            os.system("set +o history; echo "yourpassword" | sudo -S command") #after su access in by low root privileges echo 'real password' to sudo for elevated root access //
